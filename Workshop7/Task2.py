#Checks if a queen position is valid given a particular arrangement of existing queens on a chess board.
...
#Print the chessBoard using 1 for queen and 0 for empty.
def printTable(chessBoard):
